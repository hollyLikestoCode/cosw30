...
<body>
    ...
    <?php
        ...
        echo "<p>This assignment was a little challenging but easy to follow. I found the instructions to be very straightforward and working in class helped for when I did get stuck on something.</p>
        <p>I had a little trouble just figuring out how to view the page on Heroku, but connecting all the sites and uploading the file was easy.</p>"; 
